...
L["<Friend> &name:random &alts:bracket [&level &class:class] has logged:red off:red &note:bracket"] = "<好友> [&level]&name:class &alts:bracket已經 離線:red了 &note:bracket"
L["<Friend> &name:random &alts:bracket [&level &class:class] has signed:green on:green in &zone &note:bracket"] = "<好友> [&level]&name:class &alts:bracket已經在&zone 上線:green了 &note:bracket"
L["Guild Log-off Message"] = "公會成員離線訊息"
L["Guild Log-on Message"] = "公會成員上線訊息"
L["<Guild> &rank &name:random &alts:bracket [&level &class:class] has come:green online:green in &zone &note:bracket"] = "<公會> [&level]&name:class &alts:bracket已經在&zone 上線:green了(&rank)"
L["<Guild> &rank &name:random &alts:bracket [&level &class:class] has logged:red off:red &note:bracket"] = "<公會> [&level]&name:class &alts:bracket已經 離線:red了(&rank)"
